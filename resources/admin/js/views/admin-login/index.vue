        ...
        <span class="svg-container">
         <i class="el-icon-lock"></i>
          ...
          <div class="d-flex justify-content-between align-items-center">
              <el-button style="padding-left: 50px; padding-right: 50px; text-transform: uppercase" :loading="loading" type="primary"
                         @click.native.prevent="handleLogin">
                  Войти
              </el-button>

              <!--<a href="/admin/register" class="auth-link">Регистрация</a>-->
          </div>
